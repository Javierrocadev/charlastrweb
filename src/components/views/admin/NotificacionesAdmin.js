      ...
      <div class="p-1.5 min-w-full inline-block align-middle">
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            {usuariosResponse.filter((usuario) => usuario.estado === 2).map((usuario, index)=>(
              <tr key={index} class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                ...
                {rolesResponse.filter((rol) => usuario.idRole === rol.idRole).map((rol, index) => (
                <td class="h-px w-72 max-w-[2rem] align-top">
                    <div class="block p-6">
                    <span class="block text-sm text-gray-500">{rol.tipoRole}</span>
                    </div>
                </td>
                ))}
                <td class="h-px w-72 max-w-[2rem] align-top">
  ...
  >
    Activar
          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            {centroEmpresaResponse.filter((centro) => centro.estadoEmpresa === 0).map((centro, index)=>(
              <tr key={index} class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                 <td class="h-px w-px whitespace-nowrap align-top">
                  <div class="block p-6" >
                    <div class="flex items-center gap-x-3">
                ...
                <td class="h-px w-px whitespace-nowrap align-top">
                  <div class="block p-6" >
                    <div class="flex items-center gap-x-4">
                      <div>
                        <span class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{centro.direccion}</span>
                      </div>
                    </div>
                  </div>
                </td>
                ...
                <td class="h-px w-72 max-w-[2rem] align-top">
                  <div class="block p-6" >    
                    <span class="block text-sm text-gray-500">{centro.telefono}</span>
                  </div>
                </td>

                <td class="h-px w-72 max-w-[2rem] align-top">
                  <div class="block p-6" >    
                    <span class="block text-sm text-gray-500">{centro.personaContacto}</span>
                  </div>
                </td>

                <td class="h-px w-72 max-w-[2rem] align-top">
                  <div class="block p-6" >    
                    <span class="block text-sm text-gray-500">{centro.cif}</span>
                  </div>
                </td>

                <td className="h-px w-72 max-w-[2rem] align-top" key={centro.id}>
                ...
                <td class="h-px w-72 max-w-[2rem] align-top">
                  <div class="block p-6" >    
                    <span class="block text-sm text-gray-500">{centro.razonSocial}</span>
                  </div>
                </td>
                
                <td class="h-px w-72 max-w-[2rem] align-top">
                  <div class="block p-6" >    
                    <span class="block text-sm text-gray-500">{centro.idTipoEmpresa}</span>
                  </div>
                </td>
