        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-accent-200 dark:border-gray-700">
          ...
          {/* <!-- End Header --> */}
            ...
            <form className="text-black">
                <div className="form-group flex flex-row items-center p-2 flex-wrap">
                    <label htmlFor="nombre" className="shrink-0">Nombre De Nueva Tecnologia: </label>
                    <input
              type="text"
              className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-accent-100 focus:ring-accent-100 ring-accent-100 focus:ring-2 ring-offset-2 outline-0 disabled:opacity-50 disabled:pointer-events-none dark:bg-accent-200 dark:border-gray-700 dark:text-gray-400"
              id="nombre"
              style={{ margin: "30px", border: "1px solid black" }}
              value={nombreTecnologia}
              onChange={handleNombreChange}/>  
            <button  onClick={handleSubmit}  className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-green-600 bg-green-600 text-white shadow-sm hover:bg-green-800 duration-300 disabled:opacity-50 disabled:pointer-events-none ">Añadir Tecnologia</button>
          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            {tecnologiasResponse.map((tecnologia, index)=>(
              <tr key={index} class="bg-white hover:bg-gray-50 dark:bg-accent-200 dark:hover:bg-slate-800">
                ...
                <td class="h-px w-px whitespace-nowrap align-top">
                  <div class="block p-6" >
                    <div class="flex items-center gap-x-3">
                      {/* <div class="inline-block h-[2.375rem] w-[2.375rem] bg-accent-100 rounded-full" src="" alt=""></div> */}
                      <div class="grow">
                        <span class="block text-sm text-accent-100">{tecnologia.idTipoTecnologia}</span>
                      </div>
                    </div>
                  </div>
                </td>
